 ...
 * -------------------------------------------------------------------------- *
 *                                                                            *
 * Copyright (c) 121-12 by the Author.                                       *
...
public :    
    ...
    double  dL12b_x1b[125];
    double  dL12b_y1b[125];
    double  dL12b_z1b[125];     

    double  dL12b_x2[125];
    double  dL12b_y2[125];
    double  dL12b_z2[125];      
    
    double  av_d12b_x[125];
    double  av_d12b_y[125];
    double  av_d12b_z[125]; 
    ...
    double  av_d23_y[125];
    double  av_d23_z[125]; 
    double  dL_angle1[125];
    double  dL_angle1b[125];
    double  dL_angle2[125];    
    
    double  d_12_last_x[125];
    double  d_12_last_y[125];
    double  d_12_last_z[125];  
    double  d_12b_last_x[125];
    double  d_12b_last_y[125];
    double  d_12b_last_z[125];      
    double  d_13_last_x[125];
    double  d_13_last_y[125];
    double  d_13_last_z[125];      
    double  d_23_last_x[125];
    ...
    double  d_13_delta_x[125];
    double  d_13_delta_y[125];
    double  d_13_delta_z[125];      
    double  d_23_delta_x[125];
    double  d_23_delta_y[125];
    double  d_23_delta_z[125];     
    
    double  stamp_angle[125];
    double  stamp_d12_x[125];
    double  stamp_d12_y[125];
    double  stamp_d12_z[125];   
    double  stamp_d13_x[125];
    double  stamp_d13_y[125];
    double  stamp_d13_z[125]; 
    double  stamp_d23_x[125];
    double  stamp_d23_y[125];
    double  stamp_d23_z[125];    
    double  stamp_d12b_x[125];
    ...
    double  l_threebody_z[125][101];     
    
    double  av_twobody_x[125][101];
    double  av_twobody_y[125][101];
    double  av_twobody_z[125][101];    
    ...
    double  delta_l_threebody_x_last[125][101];
    double  delta_l_threebody_y_last[125][101];
    double  delta_l_threebody_z_last[125][101];      
    
    double  hist_global_12_2body_x[125][101];    
    double  hist_global_12_2body_y[125][101];    
