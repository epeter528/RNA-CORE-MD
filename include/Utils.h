...
struct     NTC_Classes {
    ...
    // NTC
     ...
     // threebody 
               ...
               int    threebody = 0;
               ResidueID sec_res_threebody;
               ResidueID third_res_threebody;
               double threebody_angle_k;
               double threebody_angle_eq;
               double threebody_bond_k;
               double threebody_bond_eq;
               double threebody_alpha;
               String sec_res_chain_threebody;
               String third_res_chain_threebody;
               
     // twobody 
               
               int    twobody = 0;
               ResidueID sec_res_twobody;
               double twobody_bond_k;
               double twobody_bond_eq; 
               double twobody_alpha;
               String sec_res_chain_twobody;
