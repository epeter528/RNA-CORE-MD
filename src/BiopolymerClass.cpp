    ...
    if ((myResidueStretch.getStartResidue() == getFirstResidueID()) && 
        ...
        validateAtomInfoVector(); return atomInfoVector;} // just return the precomputed atomInfoVector
          ...
          while ( indexResidueID2 <= myResidueStretch.getEndResidue()) { 
              ...
              //cout<<__FILE__<<":"<<__FUNCTION__<<":"<<__LINE__<<" : Residue "<<indexResidueID2.outString()<<" has "  <<myBiopolymer.updResidue( getResidueIndex(indexResidueID2) ).getNumAtoms()<<" atoms."<<endl;
          ...
          //cout<<__FILE__<<":"<<__FUNCTION__<<":"<<__LINE__<<" : number of atoms in vector<MMBAtomInfo> :"<< (vector<MMBAtomInfo>  (startAtomInfoIterator, endAtomInfoIterator+1)).size()<<endl;
